 ...
 *
 * The Renderer Stream Adapter StreamWrapper class
 *
 ...
 * @projectGroup Tale
 * @project Jade
 * @component Renderer\Adapter\Stream\Wrapper
 *
 ...
 * It works with most of the f*-functions of PHP (fopen, fread, fwrite, INCLUDE(!!!!), etc.)
 *
...
class Wrapper
{
    ...
    /**
     * This gets called when a stream is opened with the wrapper-scheme
     * this Wrapper was registered on (e.g. fopen('tale-jade://data;...'), INCLUDE('tale-jade://data;...')
     *
    ...
    /**
     * Gets called when someone calls something like ftell on this
     * stream
     *
    ...
    /**
     * Gets called when someone calls something like feof on this
     * stream
     *
